...
namespace AcArticle.Uwp.Helpers
{
    public static class ScrollViewerHelper
    {
        public static readonly DependencyProperty HorizontalScrollBarStyleProperty =
            DependencyProperty.RegisterAttached("HorizontalScrollBarStyle", typeof(Style), typeof(ScrollViewerHelper), new PropertyMetadata(default(Style), HorizontalScrollBarStyleChanged));
